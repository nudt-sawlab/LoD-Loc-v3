...
def convert_quaternion_to_euler_batch(R_c2w):
    """
...
def convert_euler_to_matrix(euler_xyz):
    ...
    # rotation = R.from_euler('zyx', euler_xyz_rad) #(yaw, pitch, roll)
...
def cgcs2000towgs84(c2w_t):
    ...
    cgcs2000 = pyproj.CRS('EPSG:4547')  # 4547 cs 4529 nb
...
def cgcs2000towgs84_batch(c2w_t):
    """Convert coordinates from CGCS2000 to WGS84.
...
def wgs84tocgcs2000(trans):
    ...
    cgcs2000 = pyproj.CRS('EPSG:4547')  # CGCS2000 CRS definition cs 4547
