...
for name in list(poses.keys()):
    ...
    # Use Workbench for fast, simple rendering
    ...
    # Use EEVEE with emission-only materials so that each building has a
    # constant color (roof == walls) and vivid colors like the OSG masks.
    scene.render.engine = "BLENDER_EEVEE"
    _make_materials_emission()
