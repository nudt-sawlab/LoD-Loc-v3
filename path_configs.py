...
def get_paths(base_path, colmap_res, mesh_type):
    ...
    # UAVD4L-LoD
    UAVD4L_LoD = ['inTraj', 'outTraj', 'Synthesis', 'Swiss_in', 'Swiss_out', 'Video', 'Japan_02', 'Japan_02_one_third', 'Japan_06', 'Japan_07', 'Seq1', 'Seq2', 'Seq3', 'Seq2_weather', 'Seq4', 'Seq5', 'Japan_06_new', 'Japan_07_new']
