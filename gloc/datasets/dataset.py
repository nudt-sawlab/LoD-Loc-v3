...
class PoseDataset(data.Dataset):
    def __init__(self, name, paths_conf, transform=None, rendered_db=None):
        ...
        # (Pdb) self.images[1]
        # Image(id=1, qvec=array([ 0.54842825,  0.8316375 , -0.07352009,  0.04690757]), tvec=array([-208.14020664,  -19.35419524,  274.47263944]), 
        # camera_id=1563, name='query/DJI_20231018092905_0017_D.JPG', xys={}, point3D_ids={})
        # (Pdb) self.images[0]
        # Image(id=0, qvec=array([ 0.54832001,  0.83178446, -0.07307995,  0.04625035]), tvec=array([-207.75879752,  -19.13229526,  274.6899452 ]), 
        # camera_id=1563, name='query/DJI_20231018092903_0016_D.JPG', xys={}, point3D_ids={})
